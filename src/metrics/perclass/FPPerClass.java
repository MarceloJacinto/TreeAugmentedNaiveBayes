 ...
 * to calculate the number of False Positives on multi-class problems
 ...
 * @since 2020-05-03
 */
public class FPPerClass extends AbstractAuxiliaryScores {

    /**
     * Constructor for the FPPerClass, receives a matrix of int (int[][] - confusion matrix) used to calculate the
     ...
     */
    public FPPerClass(int[][] confusionMatrix) {
        super(confusionMatrix);
    }

    /**
     * Implementation of the doCalculateScore method. When an index is received, calculates the score of
     * that particular class using the False Positives formula for multi-class problems
