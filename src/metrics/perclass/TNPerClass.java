 ...
 * to calculate the number of True Negatives on multi-class problems
 ...
 * @since 2020-05-03
 */
public class TNPerClass extends AbstractAuxiliaryScores {

    /**
     * Constructor for the TNPerClass, receives a matrix of int (int[][] - confusion matrix) used to calculate the
     ...
     */
    public TNPerClass(int[][] confusionMatrix) {
        super(confusionMatrix);
    }

    /**
     * Implementation of the doCalculateScore method. When an index is received, calculates the score of
     * that particular class using the True Negatives formula for multi-class problems
